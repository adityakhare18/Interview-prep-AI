...
import RoleInfoHeader from "../InterviewPrep/component/RoleInfoHeader";
...
const InterviewPrep = () => {
  ...
  const uploadMoreQuestions = async () => {
    try {
      ...
      if (error.response && error.response.data.message) {
        ...
        setError("Something went wrong while adding more questions");
      }
    } finally {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="container mx-auto pt-6 px-5 sm:px-8 lg:px-14 xl:px-24">
