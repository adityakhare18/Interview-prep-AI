...
const LandingPage = () => {
  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#FFFCEF] px-4 sm:px-6 md:px-12 lg:px-20 relative">
      ...
      <div className="w-full min-h-full relative z-10">
        <div>
          <section className="flex items-center justify-center -mt-36">
            <img
              src={HERO_IMG}
              alt="Hero img"
              className="w-[70vw] rounded-lg"
            />
          </section>
        </div>

        <div className="w-full min-h-full bg-[#FFFCEF] mt-10">
          <div className="container mx-auto px-4 pt-10 pb-20 max-w-screen-xl">
        ...
        <div className="text-sm bg-gray-50 text-secoundary text-center p-5 mt-5">
